...
//open class ____IMPRawFile: IMPImageProvider {
//    
//    public var mutex = IMPSemaphore()
//    
//    public func removeObserver(optionsChanged observer: @escaping ObserverType) {
...
//        }
//        get {
//            return (rawFilter?.value(forKeyPath: kCIInputEnableSharpeningKey) as? NSNumber)?.boolValue ?? false
//        }
//    }    
//    
...
//        }  
//        get {
//            return (rawFilter?.value(forKeyPath: kCIInputNoiseReductionAmountKey) as? NSNumber)?.floatValue ?? 0
//        }        
//    }
//    
//    public var luminanceNoiseReduction:Float  {
//        set{  
//            rawFilter?.setValue(luminanceNoiseReduction, forKey: kCIInputLuminanceNoiseReductionAmountKey)
//            renderTexture()
//        }
//        get {
//            return (rawFilter?.value(forKeyPath: kCIInputLuminanceNoiseReductionAmountKey) as? NSNumber)?.floatValue ?? 0
//        }
//    }
//    
//    public var noiseReductionDetail:Float  {
//        set{  
//            rawFilter?.setValue(noiseReductionDetail, forKey: kCIInputNoiseReductionDetailAmountKey)
//            renderTexture()
//        }
//        get {
//            return (rawFilter?.value(forKeyPath: kCIInputNoiseReductionDetailAmountKey) as? NSNumber)?.floatValue ?? 0
//        }
//    }
//    
//    public var colorNoiseReduction:Float {
//        set{  
//            rawFilter?.setValue(colorNoiseReduction, forKey: kCIInputColorNoiseReductionAmountKey)
//            renderTexture()
//        }
//        get {
//            return (rawFilter?.value(forKeyPath: kCIInputColorNoiseReductionAmountKey) as? NSNumber)?.floatValue ?? 0
//        }
//    }
//    
//    public var noiseReductionContrast:Float {
//        set{  
//            rawFilter?.setValue(noiseReductionContrast, forKey: kCIInputNoiseReductionContrastAmountKey)
//            renderTexture()
//        }
//        get {
//            return (rawFilter?.value(forKeyPath: kCIInputNoiseReductionContrastAmountKey) as? NSNumber)?.floatValue ?? 0
//        }
//    }
//    
//    public var noiseReductionSharpness:Float {
//        set{  
//            rawFilter?.setValue(noiseReductionSharpness, forKey: kCIInputNoiseReductionSharpnessAmountKey)
//            renderTexture()
//        }
//        get {
//            return (rawFilter?.value(forKeyPath: kCIInputNoiseReductionSharpnessAmountKey) as? NSNumber)?.floatValue ?? 0            
//        }
//    }
//    
//    public let storageMode: IMPImageStorageMode
...
//        rawFilter?.setValue(noiseReductionDetail, forKey: kCIInputNoiseReductionDetailAmountKey)
//        
//        rawFilter?.setValue(true, forKey: kCIInputEnableChromaticNoiseTrackingKey)
//        rawFilter?.setValue(colorNoiseReduction, forKey: kCIInputColorNoiseReductionAmountKey)
//        rawFilter?.setValue(luminanceNoiseReduction, forKey: kCIInputLuminanceNoiseReductionAmountKey)
//        
//        rawFilter?.setValue(enableSharpening, forKey: kCIInputEnableSharpeningKey)
...
//    
//    private func renderOutput() -> CIImage? {
//        if let im = rawFilter?.outputImage { 
//            _image = im
//        }
//        return _image
//    }
